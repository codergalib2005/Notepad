...
//): Modifier
internal fun Modifier.adjustTextIndicatorOffset(
    state: RichTextState,
    contentPadding: PaddingValues,
    density: Density,
    layoutDirection: LayoutDirection,
    ...
    // TODO: implement the behavior you need for Android
    // If you don’t need any special adjustment, just return `this`
    return this
}
